...
- **QA & Testing Methodologies:** Functional Testing, Regression Suites, Black-Box/Grey-Box Testing, Defect Lifecycle Tracking, Agile/Scrum, User Acceptance Testing (UAT).
- **Languages & Scripting:** Python, Bash, JSON/YAML, SQL, Markdown, HTML5/CSS3.
- **Infrastructure & Systems:** Linux (Ubuntu/Debian ARM64), Headless SSH, Cloudflare Zero Trust / Argo Tunnels, FFmpeg, Docker, Git / GitHub Actions CI/CD.
- **Enterprise Software:** JIRA, Confluence, Postman, Google Workspace, PuTTY, Ableton, Photoshop.
- **Core Competencies:** Technical Specification Writing, Root-Cause Analysis, Enterprise Configuration Management, Cross-Functional Team Leadership.

---

## 🚀 Key Engineering & Sovereign Projects

### **Self-Hosted Lightning & Bitcoin Core Node Infrastructure (24/7 Linux)**
- Architected and operate an autonomous 24/7 Bitcoin Core full node and Lightning Network Daemon (LND) layer on dedicated low-power hardware.
- Engineered automated peer failover scripts (`lnd-autoconnect-peers`) integrating multi-mempool fallback APIs and automated liquidity management.

### **Self-Hosted Zero-Server Live Video Streaming Suite**
- Designed and published an ultra-lightweight RTMP-to-HLS live streaming engine (`self-hosted-hls-streamer`) utilizing native FFmpeg ingestion (`-listen 1`) and Cloudflare Tunnel routing without requiring third-party streaming servers.

### **Distributed Compute & Hashrate Optimization**
- Custom-assembled and maintained multi-GPU compute systems, implementing custom voltage undervolting, memory clock optimizations, and thermal control automation.
