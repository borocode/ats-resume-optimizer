...
Detail-oriented **QA Analyst & Technical Systems Specialist** with extensive experience directing end-to-end quality assurance cycles, designing functional and regression test plans, and managing software configuration for high-reliability consumer and healthcare platforms. Proven ability to own QA pipelines independently, collaborate seamlessly across Agile/Scrum teams, and build resilient automated developer tools.
...
- Logged, tracked, and escalated software defects in JIRA, coordinating resolution timelines directly with software development teams in 2-week Agile sprint cycles.
...
- Maintained detailed requirement traceability matrices in JIRA, linking test cases to business specifications and user stories.
...
- **QA & Testing Methodologies:** Test Planning & Lifecycle Management, Functional Testing, Regression Suites, Smoke Testing, Traceability Matrices, Bug Triage, Agile/Scrum, UAT.
- **Tools & Platforms:** JIRA, Postman, Git / GitHub Actions, Linux / Ubuntu Terminal, Headless SSH, SQL, PuTTY, Google Workspace.
- **Languages & Formats:** Python, Bash, JSON/YAML, SQL, Markdown, HTML5/CSS3.
- **Key Competencies:** Defect Root-Cause Analysis, Technical Specification Writing, System Configuration Auditing, Cross-Functional Collaboration.

---

## 🚀 Key Engineering & Sovereign Projects

### **Autonomous Lightning & Bitcoin Core Node Infrastructure (24/7 Linux)**
- Built and maintain a 24/7 self-hosted Bitcoin Core node and Lightning Network Daemon (LND) on dedicated hardware.
- Engineered automated peer failover scripts (`lnd-autoconnect-peers`) integrating multi-mempool fallback APIs and automated channel liquidity tracking.

### **Self-Hosted Zero-Server Live Video Streaming Suite**
- Published a lightweight RTMP-to-HLS live streaming engine (`self-hosted-hls-streamer`) utilizing native FFmpeg ingestion (`-listen 1`) and Cloudflare Zero Trust tunnels without external media servers.
