...
def main():
    ...
    parser.add_argument("--name", "-n", default="Alex Boro", help="Candidate full name")
    parser.add_argument("--email", "-e", default="alex@boroghor.com", help="Candidate contact email")
